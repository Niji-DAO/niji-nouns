...
contract SVGRenderer is ISVGRenderer {
        ...
        returns (string memory svg)
    {
        ...
        //     lookup[i] = Strings.toString(i * 5);
        // }

        // string[161] memory lookup; // 80 x 5 = 400, 160 + 1 (0の分)
        // for (uint i = 0; i <= 160; i++) {
        //     lookup[i] = Strings.toString(i * 5);
        // }

        // string[193] memory lookup; // 96 x 5 = 480, 192 + 1 (0の分)
        ...
        string memory rects;
        string[] memory cache;
        for (uint256 p = 0; p < params.parts.length; p++) {
