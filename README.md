...
NijiNouns DAO is a generative avatar art collective.
...
The [nouns contracts](packages/nouns-contracts) is the suite of Solidity contracts powering NijiNouns DAO.
...
The [nouns webapp](packages/nouns-webapp) is the frontend for interacting with Noun auctions as hosted at [niji-nouns.wtf](https://niji-nouns.wtf).
